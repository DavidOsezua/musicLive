  ...
  const dashboardSummary = [
    {
      ...
      status: [
        ...
        {
          state: "Pending",
          number: (totalresultBandData.total || 0) - (totalresultBandData.is_verified || 0),
          colorID: "pending",
        },
        {
          state: "inactive",
    ...
    },
    {
      ...
      image: venueImg,
      status: [
        { state: "active", number: totalresultVenueData.is_verified || 0, colorID: "active" },
        { state: "Pending", number: (totalresultVenueData.total || 0) - (totalresultVenueData.is_verified || 0), colorID: "pending" },
    ...
    },
    {
      ...
      status: [
        ...
        {
          state: "inactive",
          number: (totalresultBandData.total || 0) - (totalresultBandData.admin_approved || 0),
          colorID: "inactive",
        },
      ],
      colorID: "genre",
    ...
    },
    {
      ...
      image: ads,
      status: [
        { state: "active", number: totalresultAdsData.admin_approved || 0, colorID: "active" },
        { state: "Pending", number: (totalresultAdsData.total || 0) - (totalresultAdsData.admin_approved || 0), colorID: "pending" },
        { state: "inactive", number: 0, colorID: "inactive" },
      ],
      colorID: "band",
      buttonText: "Add Ads +",
    },
    {
      ...
      image: venueImg,
      status: [
        { state: "active", number: totalresultVenueData.admin_approved || 0, colorID: "active" },
        { state: "Pending", number: (totalresultVenueData.total || 0) - (totalresultVenueData.admin_approved || 0), colorID: "pending" },
        { state: "inactive", number: 0, colorID: "inactive" },
      ],
      colorID: "venue",
      buttonText: "Add Venue +",
      ...
      <div className={`${styles.emailCard}`}>
        <div className={`${styles.emailcontainer}`}>
          ...
          <div className="flex gap-3 w-full">
            <Button text={`Export Email`} width={`w-full`} radius={`rounded-[5px]`} />
            <Button colored text={`See Details`} width={`w-full`} radius={`rounded-[5px]`} />
          </div>
        </div>
